    ...
    this.tabs = [
      {
        ...
        content: [
          ...
          {option: Option, props: {type: "toggle", title: "Include Flows in metadata search", key: "metadataSearchIncludeFlows"}},
          {option: Option, props: {type: "toggle", title: "Include Profiles in metadata search", key: "metadataSearchIncludeProfiles"}},
          {option: Option, props: {type: "toggle", title: "Include Permission Sets in metadata search", key: "metadataSearchIncludePermSets"}},
          {option: Option, props: {type: "toggle", title: "Include Networks in metadata search", key: "metadataSearchIncludeNetworks"}},
          {option: Option, props: {type: "toggle", title: "Include Apex Classes in metadata search", key: "metadataSearchIncludeApexClasses"}},
